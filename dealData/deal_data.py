...
# unlabel_data_14 = pd.read_csv('./data/unlabel_data_14.csv')
# unlabel_data_15 = pd.read_csv('./data/unlabel_data_15.csv')
# unlabel_data_14 = unlabel_data_14.drop(['pt'],axis = 1)
# unlabel_data_15 = unlabel_data_15.drop(['pt'],axis = 1)
# label_data = pd.concat([unlabel_data_14,unlabel_data_15])
...
label_data.iloc[:,1:-1] = label_data.iloc[:,1:-1].apply(preprocessing.scale)
label_data.to_csv('unlabel_data_scale.csv',index = False)
# print(label_data)
