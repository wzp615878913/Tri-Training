...
label = pd.read_csv('./2014_data_new/onlyLabel.csv')
feature = pd.read_csv('./2014_data_new/feature.csv')
...
# label_data.to_csv('./2014_data_new/label_data.csv',index = False)
unlabel_data = data[pd.isnull(data['type'])]
unlabel_data.to_csv('./2014_data_new/unlabel_data.csv',index = False)
# print(unlabel_data)